...
function Footer() {
  ...
  return (
    <footer className="bg-gray-900">
      <div className="px-4 pt-16 pb-6 mx-auto max-w-screen-2xl sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            >
              Milmapure: Where Tradition Meets Flavor. Pure, Natural, and
              Chemical-Free Spice Blends for Culinary Excellence.
            </p>
            <ul className="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
              <li>
                <Link
                  href="https://www.facebook.com/profile.php?id=61560898775836&mibextid=LQQJ4d"
                  legacyBehavior
                >
                  <a
                    className="text-[#ca2020] transition hover:text-[#ca2020]/75"
                    target="_blank"
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 sm:justify-start">
                  ...
                  <address className="-mt-0.5 not-italic text-white">
                    Block No. MOUZA-11 khagenhat khagenhat Falakata alipurduar
                    735204
                  </address>
                </li>
              </ul>
        ...
        <div className="pt-6 mt-12 border-t border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            ...
            <p className="mt-4 text-sm text-gray-400 sm:mt-0">
              &copy; 2024 tsfoodproduct. All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
